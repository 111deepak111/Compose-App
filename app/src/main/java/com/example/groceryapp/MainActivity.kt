...
//import ark.coding.groceryapp.ui.theme.GroceryAppTheme
        ...
        Row(
            ...
            Row(Modifier
                ...
                Column(Modifier.padding(8.dp)) {
                    ...
                    Text(text = "Top Up", color = MaterialTheme.colors.primary, fontSize =10.sp)
                }
            }
            ...
            Row(Modifier
                ...
                Column(Modifier.padding(8.dp)) {
                    ...
                    Text(text = "Points", color = Color.LightGray, fontSize = 10.sp)
                }
            }
        }
    }
